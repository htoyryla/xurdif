...
def diffusion_run(modelsel, im, o,  prompt_img = None):
    ...
    def cond_fn(x, t, x_s):
        ...
        if prompt_img is not None:
            ...
            if o.spher:
                ...
                loss1 = o.imgw * 10*(1-torch.cosine_similarity(imgp_enc, img_enc)).view(-1, bs).T.mean(1)
        ...
        print(o.lr, grad.norm().item(), losses) 
    ...
    for i in timesteps:
        ...
        with torch.no_grad():
            ...
            if (o.text!="" and o.textw > 0) or (prompt_img is not None and o.imgpw > 0):
...
with gr.Blocks() as demo:
    ...
    def run(o, imo, ms, t, s, m, im_in, skip, weak, prompt_img, imgw, imageSize, cuts):
    ...
    text_button.click(fn=run,  concurrency_limit=1, inputs=[opt_, imo, modelsel, text_input, textw, mul, init_image, skip, weak, prompt_img, imgw, imageSize, cuts], outputs=[image_output, image_output_raw, image_internal, imo, opt_, process_status])
